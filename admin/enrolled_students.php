...
<div class="content">
  <div class="container-fluid p-2 bg-dark">
    <h4 class="bg-light p-3" align="center"><strong>Manage Enrolled Students</strong></h4>  
         ...
         <?php
           ...
           ?>
            <tr>
                ...
                <td>
                    <!-- <a href="edit_enrollment.php?edit_enrollment=<?php echo $row['enrollment_id'];?>" class="btn btn-success"><i class="bi bi-pencil-square"></i> Edit</a> -->
                    ...
                    <!-- <button class="btn btn-danger" data-bs-toggle="modal" type="button" data-bs-target="#deletestudent<?php echo $row['enrollment_id']; ?>" id="btn_no-outline"><i class="bi bi-trash"></i> Delete</button> -->  
                </td>
            </tr>
          <?php  
             include 'enrolled_students_delete_student.php';
             include 'enrolled_students_view_profile.php';
